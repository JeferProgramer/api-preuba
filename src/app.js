...
server.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Origin', '*'); // update to match the domain you will make the request from el * para decirle que utilize todo lo que le llega de front es libre
